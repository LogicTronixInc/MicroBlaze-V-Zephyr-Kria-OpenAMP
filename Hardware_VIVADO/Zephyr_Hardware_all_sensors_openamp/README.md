...
- design_1_wrapper.bit (block_design_wrapper_name.bit) (found inside the vivado project location under project_name.runs/impl_1)

- design_1_wrapper.mmi (block_design_wrapper_name.mmi) (found inside the vivado project location under project_name.runs/impl_1)
