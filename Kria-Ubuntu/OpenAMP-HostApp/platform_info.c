...
#define SHM_DEV_NAME "2ed20000.shm" /* shared device name */

#define RSC_MEM_PA 0x2ED20000UL
#define RSC_MEM_SIZE 0x2000UL
#define VRING_MEM_PA 0x2ED40000UL
#define VRING_MEM_SIZE 0x8000UL
#define SHARED_BUF_PA 0x2ED48000UL
...
extern struct remoteproc_ops zynqmp_linux_ublaze_proc_ops;
...
platform_create_proc(int proc_index, int rsc_index)
{
	...
	if (!remoteproc_init(&rproc_inst, &zynqmp_linux_ublaze_proc_ops,
						 &rproc_priv))
		return NULL;
