 ...
 * FILE NAME
 *
 *    zynqmp_linux_ublaze_proc.c
 *
 * DESCRIPTION
 *
 *    This file define Xilinx Microblaze to ZynqMP A53 platform specific
 *    remoteproc implementation ops.
 *
 **************************************************************************/
...
#ifndef RPMSG_NO_IPI
static int zynqmp_linux_ublaze_proc_irq_handler(int vect_id, void *data)
{
...
zynqmp_linux_ublaze_proc_init(struct remoteproc *rproc,
							  struct remoteproc_ops *ops, void *arg)
{
	...
	metal_irq_register(irq_vect, zynqmp_linux_ublaze_proc_irq_handler, rproc);
	metal_irq_enable(irq_vect);
	metal_io_write32(prproc->ipi_io, IPI_IER_OFFSET,
					 prproc->ipi_chn_mask);
	printf("Successfully initialized Linux ublaze remoteproc.\r\n");
	return rproc;
#endif /* !RPMSG_NO_IPI */
	printf("Successfully initialized Linux ublaze remoteproc.\r\n");
	return rproc;
...
static void zynqmp_linux_ublaze_proc_remove(struct remoteproc *rproc)
{
	struct remoteproc_priv *prproc;
#ifndef RPMSG_NO_IPI
	struct metal_device *dev;
...
static void *
zynqmp_linux_ublaze_proc_mmap(struct remoteproc *rproc, metal_phys_addr_t *pa,
...
static int zynqmp_linux_ublaze_proc_notify(struct remoteproc *rproc, uint32_t id)
{
	struct remoteproc_priv *prproc;
...
/* processor operations from ublaze to a53. It defines
 * notification operation and remote processor managementi operations. */
struct remoteproc_ops zynqmp_linux_ublaze_proc_ops = {
	.init = zynqmp_linux_ublaze_proc_init,
	.remove = zynqmp_linux_ublaze_proc_remove,
	.mmap = zynqmp_linux_ublaze_proc_mmap,
	.notify = zynqmp_linux_ublaze_proc_notify,
	.start = NULL,
	.stop = NULL,
	.shutdown = NULL,
};
